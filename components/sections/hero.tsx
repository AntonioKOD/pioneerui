        ...
        <div className="z-10 flex flex-col">
          <div className="mt-10 grid grid-cols-1 md:mt-20">
            <div className="flex flex-col items-start gap-6 px-7 pb-8 text-center md:items-center md:px-10">
              ...
              Craft Exceptional Interfaces with PioneerUI – 
              The Ultimate Component Library for, built with <b>React</b>, <b>Typescript</b>, <b>TailwindCSS</b>, <b>Motion</b>.<br />
                <br />
              </p>

              <div className="mx-0 flex w-full max-w-full flex-col gap-4 py-1 sm:max-w-lg sm:flex-row md:mx-auto ">
                <div className="flex w-full flex-col gap-2 sm:flex-row sm:gap-4 items-center justify-center">
                  <Link
                    href="/docs"
                    className={cn(
                      buttonVariants({
