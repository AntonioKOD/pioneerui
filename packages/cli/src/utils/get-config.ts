...
export const DEFAULT_COMPONENTS_PIONEERUI = "@/components/pioneerui";
...
export async function resolveConfigPaths(cwd: string, config: RawConfig) {
  ...
  const pioneerui = `${components}/pioneerui`;

  const newAliases = {
    ui: `${config.aliases.components}/ui`,
    pioneerui: `${config.aliases.components}/pioneerui`,
  };
  ...
  const newConfig = {
    ...
    resolvedPaths: {
      ...
      pioneerui,
      //   ? await resolveImport(config.aliases["pioneerui"], tsConfig)
